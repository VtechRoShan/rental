    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span class="fw-bold ">{{ $rent_room_data->floor}}</span></td>
                <td><span class="fw-normal">{{ $rent_room_data->parking}}</span></td>                        
                <td><span class="fw-normal">{{ $rent_room_data->available_for}}</span></td>
                <td><span class="fw-bold">{{ $rent_room_data->toilet_bathroom}}</span></td>
                {{-- <td><span class="fw-bold ">{{ $rent_room_data->kitchen}}</span></td>
                <td><span class="fw-normal">{{ $rent_room_data->district}}</span></td>                        
                <td><span class="fw-normal">{{ $rent_room_data->city}}</span></td>
                <td><span class="fw-bold">{{ $rent_room_data->municipal}}</span></td> --}}
                <td><span class="fw-bold ">{{ $user_ip_address}}</span></td> 
                <td><span class="fw-normal">{{ $rent_room_data->nearby_school}}</span></td>                        
                <td><span class="fw-normal">{{ $rent_room_data->nearby_hospital}}</span></td> 
                <td> 
