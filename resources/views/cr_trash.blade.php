...
@endif
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{route('my-uploads')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <tr>
                ...
                <td> 
                    <div class="btn-group btn-sm" role="group" >
                        <button type="button" class="btn btn-success btn-sm"   data-toggle="tooltip"  title="Restore ">  <i class=""> <a  href="{{ route('restore_upload',[$rent_room_data->id])}}">Restore</a>  </i> </button>
                        <button type="button" class="btn btn-danger btn-sm"  data-toggle="tooltip"  title="Delete Permenantly"> <i class=""> <a  href="{{route('forcedelete_upload',[$rent_room_data->id])}}">Delete</a> </i> </button>
                    </div>
                </td>
                </td>
