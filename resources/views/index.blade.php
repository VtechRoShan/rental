...
@endif --}}
    <div class="btn-toolbar mb-2 mb-md-0" >
        <a href="{{route('trash')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-sm" role="group" >
                            <button type="button" class="btn btn-primary btn-sm"   data-toggle="tooltip"  title="View Post">  <i class="fa-solid fa-binoculars"> View</i> </button>
                            <button type="button" class="btn btn-warning btn-sm"  data-toggle="tooltip"  title="Delete Post"> <i class="fa-regular fa-trash-can"> <a  href=" {{route('delete',[$data->id])}}">Trash</a> </i> </button>
                        </div>
                    </td>
                </tr>
            @endforeach
