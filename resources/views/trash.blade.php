...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{route('index')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
            Go to Index
        </a>
        <div class="btn-group ms-2 ms-lg-3">
            <button type="button" class="btn btn-sm btn-outline-gray-600"> <a href="{{route('create')}}"> <b>+</b> Add New </a> </button>
        </div>
    </div>
</div>
...
<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <h3> This is trash Table</h3>
    <table class="table table-hover">
        <thead>
            <tr>
                <th class="border-gray-200">Name</th>
                <th class="border-gray-200">email</th>						
                <th class="border-gray-200">Yourself</th>
                <th class="border-gray-200">School</th>
        ...
        <tbody>
            ...
            @foreach ($datas as $data)
                <tr>
                    ...
                    <td><span class="fw-normal">{{ $data->email}}</span></td>
                    <td><span class="fw-bold">{{ $data->yourself}}</span></td>
                    <td><span class="fw-bold ">{{ $data->school}}</span></td>
                    <td>
                        <div class="btn-group btn-sm" role="group" >
                            <button type="button" class="btn btn-primary btn-sm"   data-toggle="tooltip"  title="Delete Post">  <i class="fa-solid fa-binoculars"> <a  href=" {{route('forcedelete',[$data->id])}}">Delete</a>  </i> </button>
                            <button type="button" class="btn btn-warning btn-sm"  data-toggle="tooltip"  title="Restore Post"> <i class="fa-regular fa-trash-can"> <a  href=" {{route('restore',[$data->id])}}">Restore</a> </i> </button>
                        </div>
                    </td>
                </tr>
            @endforeach
