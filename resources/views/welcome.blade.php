            ...
            <article class="postcard light blue">
              <a href="hello">
                ...
                <div class="postcard__text t-dark">
                    <h1 class="postcard__title blue"><a href="#">{{$data->size}} <span style="color:red; font-size:24px;" > {{$data->type}} available on  </span> {{$data->area_name}} </a></h1>
                    ...
                    <div> Address: {{$data->state}} {{$data->district}} {{$data->city}} {{$data->municipal}}  {{$data->area_name}}</div>
                    <div class="col-md-12">
                  ...
                  <button class="col-6 mx-auto btn btn-info"> <a href="{{route('landing_view') }}" style="text-decoration: none"> <strong> View Room</strong> </a></button>
              </a>
            </article>
            <br> <hr> <br>
            @endforeach
